...
(function(k) {
    ...
    function Eb(a) {
        ...
        for (b = h.length; l < b; l++) {
            ...
            e && m.appendTo(c);
            a.oFeatures.bSort &&
                (m.addClass(n.sSortingClass), !1 !== n.bSortable &&
            ...
            for (d = e.length; l < d; l++) {
                ...
                for (b = e[l].length; f < b; f++) {
                    ...
                    if (g[l][f] === q) {
                        ...
                        for (
                            g[l][f] = 1; e[l + h] !== q && e[l][f].cell == e[l + h][f].cell;
    ...
    function Sb(a) {
        for (
            var b = u.ext.search, c = a.aiDisplay, d, f, e = 0, g = b.length; e < g; e++
        ) {
    ...
    function bc(a, b) {
        ...
        for (
            var e, g = u.ext.type.order[c.sType + "-pre"], h = 0, l = a.aoData.length; h < l; h++
        )
            if (
                ((c = a.aoData[h]),
